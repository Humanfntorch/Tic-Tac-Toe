...
{	
	 ...
	 */
	private ImageIcon defaultX = new ImageIcon(getClass().getResource("X.png"));
	private ImageIcon defaultO = new ImageIcon(getClass().getResource("O.png"));
	private ImageIcon bats = new ImageIcon(getClass().getResource("Batman.png"));
	private ImageIcon jokes = new ImageIcon(getClass().getResource("Joker.png"));
	private ImageIcon bends = new ImageIcon(getClass().getResource("Bender.png"));
	private ImageIcon fry = new ImageIcon(getClass().getResource("Fry.png"));
	private ImageIcon flower = new ImageIcon(getClass().getResource("FlowerO.png"));
	private ImageIcon twigs = new ImageIcon(getClass().getResource("twigs.png"));
	private ImageIcon gears = new ImageIcon(getClass().getResource("Gears.png"));
	private ImageIcon halo = new ImageIcon(getClass().getResource("haloX.png"));
	private ImageIcon orgO = new ImageIcon(getClass().getResource("originalO.png"));
	private ImageIcon orgX = new ImageIcon(getClass().getResource("originalX.png"));
	private ImageIcon sCat = new ImageIcon(getClass().getResource("spaceCat.png"));
	private ImageIcon sDog = new ImageIcon(getClass().getResource("spaceDog.png"));
	private ImageIcon pig = new ImageIcon(getClass().getResource("Piglet.png"));
	private ImageIcon pooh = new ImageIcon(getClass().getResource("Pooh.png"));
    private ImageIcon player1 = defaultX;
    private ImageIcon player2 = defaultO;
